...
export default function Faqs() {
    ...
    return (
        ...
        '>
            <h2 className='font-black font-dharma-gothic-e text-[6.4rem] leading-[5.3rem] mb-[4rem] uppercase'>
                Faqs
            </h2>
