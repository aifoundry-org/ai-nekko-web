            ...
            <div className='relative w-full flex bg-black rounded-t-[2rem] text-sand'>
                ...
                '>
                    ...
                    '>
                        ...
                        '>
                            <div onClick={() => window.open('https://ai-foundry.litebox.dev')} className='cursor-pointer relative after:bg-white after:absolute after:top-[2rem] after:h-1 after:w-0 after:bottom-0 after:left-0 focus:after:w-full hover:after:w-full after:transition-all after:duration-300' >ai foundry</div>
                            {pathname == "/" && <div onClick={() => window.location.href='/#team'} className='cursor-pointer relative after:bg-white after:absolute after:top-[2rem] after:h-1 after:w-0 after:bottom-0 after:left-0 focus:after:w-full hover:after:w-full after:transition-all after:duration-300' >team</div>}
                        ...
                        '>
                            <div className='cursor-pointer relative after:bg-white after:absolute after:top-[2rem] after:h-1 after:w-0 after:bottom-0 after:left-0 focus:after:w-full hover:after:w-full after:transition-all after:duration-300' onClick={() => window.open('https://ai-foundry.litebox.dev')}>ai foundry</div>
