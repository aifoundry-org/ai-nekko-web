                ...
                '>
                    ...
                    '>
                        ...
                        '>
                            ...
                            <div onClick={() => window.location.href='/#team'} className={`${pathname !== "/" ? 'text-[#808080] navbar-team-link pointer-events-none' : 'cursor-pointer'} relative after:bg-white after:absolute after:top-[2rem] after:h-1 after:w-0 after:bottom-0 after:left-0 focus:after:w-full hover:after:w-full after:transition-all after:duration-300`} >team</div>
